                                ...
                                <div class="sumary-product single-layout">
                                    <div class="media">
                                        <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                                            <li><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvoYoAzSLYwbpqcym261i1pkDldVJDv04mh85WHWo6G9IAJ-HcRen4cbdHAqq-x8BnvpQ&usqp=CAU" alt="" width="500" height="500"></li>
                                        </ul>
                                    </div>
                                            ...
                                            <div class="contain-product layout-default">
                                                <div class="product-thumb">
                                                    <a href="single_product.php?status=sigleproduct&&id=<?php echo $rpro['pdt_id']; ?>" class="link-to-product">
                                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvoYoAzSLYwbpqcym261i1pkDldVJDv04mh85WHWo6G9IAJ-HcRen4cbdHAqq-x8BnvpQ&usqp=CAU" alt="dd" width="270" height="270" class="product-thumnail">
                                                    </a>
                                                </div>
                                                <div class="info">
